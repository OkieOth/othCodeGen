 ...
 * @author hulk
 */
class FactoryInterfGenerator_Test {
    @Test
    public void normalFactory() {
        def model = new ResManModel_v2()
        def generator = new de.othsoft.codeGen.impl.groovy.dao.FactoryInterfGenerator()
    ...
    @Test
    public void jdbcFactory() {
        def model = new ResManModel_v2()
        def generator = new de.othsoft.codeGen.impl.groovy.dao.jdbc.JdbcFactoryInterfGenerator()
        def params = [packageName:'de.gCodeGen.test',
            destPathRoot:'src/generated/java',
            testPathRoot:'src/generated/test']
        generator.genCode(model,params)
